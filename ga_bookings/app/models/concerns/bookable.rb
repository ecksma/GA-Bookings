module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      classroom.bookings.end_during(start_time, end_time),
      classroom.bookings.start_during(start_time, end_time),
      classroom.bookings.happening_during(start_time, end_time),
      classroom.bookings.enveloping(start_time, end_time),
      classroom.bookings.identical(start_time, end_time)
    ].flatten
