...
class CohortsControllerTest < ActionController::TestCase
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post :create, cohort: { end_date: @cohort.end_date, name: @cohort.name, start_date: @cohort.start_date }
    end
  ...
  test "should update cohort" do
    patch :update, id: @cohort, cohort: { end_date: @cohort.end_date, name: @cohort.name, start_date: @cohort.start_date }
    assert_redirected_to cohort_path(assigns(:cohort))
  end
